...
function calcularSuma() {
    ...
    //--------------------Aqui va la solicion del ejercicio 1--------------------
       mostrarResultado('resultado-suma', `suma=${num1 + num2}`, true);
...
function calcularPromedio() {
    ...
    mostrarResultado('resultado-promedio', `Promedio=${(prom1 + prom2 + prom3)/3}`, true);
...
function calcularEdadDias() {
    ...
    mostrarResultado('resultado-edad', `Edad Dias=${anos * 365}`, true);
...
function calcularMinutosAno() {
    ...
    const totalMinutos = diasEnAno * horasPorDia * minutosPorHora;
      ...
      mostrarResultado('resultado-edad', `Edad en minutos = ${totalMinutos}`, true);
...
function calcularPrecioConImpuesto() {
    ...
    //--------------------Aqui va la solicion del ejercicio 5--------------------
        ...
        mostrarResultado('precioFinal', `precio= ${precioFinal}`, true);
